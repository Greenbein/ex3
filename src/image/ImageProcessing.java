...
public class ImageProcessing {
    ...
    public Color[][] imagePadding(Color[][] image) {
        ...
        for (int row = startRow; row < startRow + originalRowsNumber; row++) {
            for (int col = startCol; col < startCol + originalColsNumber; col++) {
    ...
    /**
     * copy color array
     * @param image - object that has a 2d array of colors
     * @return a copy of image's color array
     */
    public Color[][] convertImageToColorArr
            (Image image) {
